...
class HomeZikrPage extends StatefulWidget {
  const HomeZikrPage({super.key});

  @override
  State<HomeZikrPage> createState() => _HomeZikrPageState();
}

class _HomeZikrPageState extends State<HomeZikrPage> {
  @override
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5),
                    SizedBox(
                      width: MediaQuery.of(context).size.width - 40 - 30 - 64,
                      child: Text(
                        '''Субхана зиль-мульки валь-малакут. Субхана зиль-'иззати валь-'азамати в Субхана зиль-'иззати валь-'азамати вСубхана зиль-'иззати валь-'азамати в''',
                        style: ts87_14_400_0,
                        maxLines: 3,
